...
var _default = function _default(_ref) {
  var data = _ref.data,
      ...
      _ref$withProto = _ref.withProto,
      withProto = _ref$withProto === void 0 ? true : _ref$withProto;

  // Generate a data tree or use the one provided
  var node = dataTree || _getNode(data, null, withProto); // Use the data tree to populate the DOM tree
...
var _getNode = function getNode(value) {
  ...
  var withProto = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
  var node = {};
  node.value = value;
  node.parent = parent;
...
var getChildren = function getChildren(parent, withProto) {
  ...
  var children = [].concat((0, _toConsumableArray2["default"])(members), (0, _toConsumableArray2["default"])(properties), proto).filter(function (child) {
  ...
  return children.map(function (child) {
    ...
    return {
      ...
      getNode: function getNode() {
        return circularAncestor || _getNode(value, parent, withProto);
