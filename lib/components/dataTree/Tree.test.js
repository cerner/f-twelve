...
describe('Tree', function () {
  describe('#getNode', function () {
    it('should build a tree', function () {
      ...
      _assert["default"].strictEqual(tree.children[0].node.value, data.stringValue);

      _assert["default"].strictEqual(tree.children[1].key, 'arrayValue');

      _assert["default"].strictEqual(tree.children[1].node.value, data.arrayValue);
    });
    it('should handle circular references', function () {
      ...
      _assert["default"].strictEqual(tree.children[0].node.value, data.circular);

      _assert["default"].strictEqual(tree.children[0].node.children[0].key, 'circular');

      _assert["default"].strictEqual(tree.children[0].node.children[0].node.value, data.circular);
    });
    it('should handle deep circular references', function () {
      ...
      _assert["default"].strictEqual(tree.children[0].node.children[0].key, 'regularKey');

      _assert["default"].strictEqual(tree.children[0].node.children[0].node.value, 'regularValue');

      _assert["default"].strictEqual(tree.children[0].node.children[1].key, 'level2');

      _assert["default"].strictEqual(tree.children[0].node.children[1].node.value, data.level1.level2);

      _assert["default"].strictEqual(tree.children[0].node.children[1].node.children[0].key, 'level3');

      _assert["default"].strictEqual(tree.children[0].node.children[1].node.children[0].node.value, data.level1.level2.level3);

      _assert["default"].strictEqual(tree.children[0].node.children[1].node.children[0].node.children[0].key, 'circular');

      _assert["default"].strictEqual(tree.children[0].node.children[1].node.children[0].node.children[0].node.value, data.level1);

      _assert["default"].strictEqual(tree.children[0].node.children[1].node.children[0].node.children[0].node.value, data.level1.level2.level3.circular);
    });
  });
